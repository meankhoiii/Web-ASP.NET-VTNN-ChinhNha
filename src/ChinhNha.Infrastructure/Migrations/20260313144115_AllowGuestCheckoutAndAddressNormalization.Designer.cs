...
namespace ChinhNha.Infrastructure.Migrations
{
    ...
    [Migration("20260313144115_AllowGuestCheckoutAndAddressNormalization")]
    partial class AllowGuestCheckoutAndAddressNormalization
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ChinhNha.Domain.Entities.SavedSearchFilter", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ChinhNha.Domain.Entities.SearchAnalytics", b =>
                {
                    ...
                    b.Property<int?>("AverageViewTimeSeconds")
                        .HasColumnType("int");

                    b.Property<int?>("ConvertedProductId")
                        .HasColumnType("int");

                    b.Property<bool>("ConvertedToView")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("ChinhNha.Domain.Entities.ProductRecommendation", b =>
                {
                    b.HasOne("ChinhNha.Domain.Entities.Product", "RecommendedProduct")
                        .WithMany()
                        .HasForeignKey("RecommendedProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ChinhNha.Domain.Entities.Product", "RelatedProduct")
                        .WithMany()
